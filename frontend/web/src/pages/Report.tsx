...
//   const titleList = [
//     { name: '선택', accessor: 'selected' },
//     { name: '장비 번호', accessor: 'machineNumber' },
//     { name: '장비 명', accessor: 'machineName' },
//     { name: '담당자', accessor: 'workerName' },
//     { name: 'LOTO 목적', accessor: 'tasktype' },
//     { name: '사고 여부', accessor: 'accident' },
//     { name: '사고 유형', accessor: 'accidentType' },
//     { name: '인명피해(명)', accessor: 'victimsNum' },
//     { name: '시작 일시', accessor: 'taskStartDateTime' },
//     { name: '종료 일시', accessor: 'taskEndDateTime' },
//   ];
...
//           <Title key={index}>{data}</Title>
//         ))}
//       </TitleBox>
//       <ContentBox>
//         {reportData.map((data, index) => (
//           <DataTitleBox onClick={() => handleReport(data.reportId)}>
//             <Title onClick={(event) => handleSelectToggle(index, event, data)}>
//               {data.selected ? (
